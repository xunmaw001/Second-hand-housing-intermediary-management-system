...
var centerMenu = [
    ...
    ,{
        name: '出租收藏',
        url: '../chuzuCollection/list.html'
    }
    ,{
        name: '卖房收藏',
        url: '../maifangCollection/list.html'
    }
...
var indexNav = [
    ...
    {
        name: '小区',
        url: './pages/xiaoqu/list.html'
    },
    {
        name: '出租',
        url: './pages/chuzu/list.html'
    },
    {
        name: '卖房',
        url: './pages/maifang/list.html'
    },

]

var adminurl =  "http://localhost:8080/ershoufang/admin/dist/index.html#/login";
