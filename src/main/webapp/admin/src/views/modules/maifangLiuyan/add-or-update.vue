...
<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='maifang' && sessionTable !='yonghu'">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="maifangLiuyanText">
                        <el-input type="textarea"  :readonly="ro.maifangLiuyanText" v-model="ruleForm.maifangLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.maifangLiuyanText" label="留言内容" prop="maifangLiuyanText">
                            <span v-html="ruleForm.maifangLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //当前text不能修改
            this.ro.maifangLiuyanText = true;
            if (this.role != "管理员"){
            }
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='maifangLiuyanText'){
                          this.ruleForm.maifangLiuyanText = obj[o];
                          this.ro.maifangLiuyanText = true;
                          continue;
                      }
                      if(o=='replyText'){
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`maifangLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.maifangLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
