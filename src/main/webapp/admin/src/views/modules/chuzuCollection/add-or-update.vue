    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="chuzuCollectionTypes">
                        <el-select v-model="ruleForm.chuzuCollectionTypes" placeholder="请选择类型">
                            <el-option
                                v-for="(item,index) in chuzuCollectionTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="类型" prop="chuzuCollectionValue">
                        <el-input v-model="ruleForm.chuzuCollectionValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    chuzuId: false,
                    yonghuId: false,
                    chuzuCollectionTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    chuzuId: '',
                    yonghuId: '',
                    chuzuCollectionTypes: '',
                    insertTime: '',
                },
                chuzuCollectionTypesOptions : [],
                chuzuOptions : [],
                yonghuOptions : [],
                rules: {
                   chuzuId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=chuzu_collection_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.chuzuCollectionTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='chuzuCollectionTypes'){
                          this.ruleForm.chuzuCollectionTypes = obj[o];
                          this.ro.chuzuCollectionTypes = true;
                          continue;
                      }
                      if(o=='insertTime'){
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`chuzuCollection/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.chuzuCollectionCrossAddOrUpdateFlag = false;
                                        this.parent.search();
