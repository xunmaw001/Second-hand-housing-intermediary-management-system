...
<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='maifang'">
                    <el-form-item class="select" v-if="type!='info'"  label="卖房" prop="maifangId">
                        <el-select v-model="ruleForm.maifangId" filterable placeholder="请选择卖房" @change="maifangChange">
                            <el-option
                                    v-for="(item,index) in maifangOptions"
                                    v-bind:key="item.id"
                                    :label="item.maifangName"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='maifang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="房间" prop="maifangName">
                        <el-input v-model="maifangForm.maifangName"
                                  placeholder="房间" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="房间" prop="maifangName">
                            <el-input v-model="ruleForm.maifangName"
                                      placeholder="房间" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24" v-if="sessionTable !='maifang' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.maifangPhoto" label="房屋图片" prop="maifangPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (maifangForm.maifangPhoto || '').split(',')" :src="item" width="100" height="100">
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.maifangPhoto" label="房屋图片" prop="maifangPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.maifangPhoto || '').split(',')" :src="item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='maifang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="房屋类型" prop="fangxingValue">
                        <el-input v-model="maifangForm.fangxingValue"
                ...
                <el-col :span="12"  v-if="sessionTable !='maifang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="房屋平方" prop="pingfang">
                        <el-input v-model="maifangForm.pingfang"
                ...
                <el-col :span="12"  v-if="sessionTable !='maifang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="每平米/价格" prop="maifangMoney">
                        <el-input v-model="maifangForm.maifangMoney"
                                  placeholder="每平米/价格" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="每平米/价格" prop="maifangMoney">
                            <el-input v-model="ruleForm.maifangMoney"
                                      placeholder="每平米/价格" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='maifang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="装修方式" prop="zhuangxiuValue">
                        <el-input v-model="maifangForm.zhuangxiuValue"
                ...
                <el-col :span="12"  v-if="sessionTable !='maifang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="房屋朝向" prop="chaoxiangValue">
                        <el-input v-model="maifangForm.chaoxiangValue"
                ...
                <el-col :span="12"  v-if="sessionTable !='maifang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="楼层" prop="louceng">
                        <el-input v-model="maifangForm.louceng"
                ...
                <el-col :span="12"  v-if="sessionTable !='maifang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="所属区域" prop="quyuValue">
                        <el-input v-model="maifangForm.quyuValue"
                ...
                <el-col :span="12"  v-if="sessionTable !='maifang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="是否卖出" prop="maifangValue">
                        <el-input v-model="maifangForm.maifangValue"
                                  placeholder="是否卖出" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="是否卖出" prop="maifangValue">
                            <el-input v-model="ruleForm.maifangValue"
                                      placeholder="是否卖出" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='maifang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="房屋特色" prop="tese">
                        <el-input v-model="maifangForm.tese"
                ...
                <el-col :span="12"  v-if="sessionTable !='maifang' ">
                    <el-form-item class="input" v-if="type!='info'"  label="详细地址" prop="xiangxi">
                        <el-input v-model="maifangForm.xiangxi"
            ...
            <input id="maifangId" name="maifangId" type="hidden">
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="maifangCollectionTypes">
                        <el-select v-model="ruleForm.maifangCollectionTypes" placeholder="请选择类型">
                            <el-option
                                v-for="(item,index) in maifangCollectionTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="类型" prop="maifangCollectionValue">
                        <el-input v-model="ruleForm.maifangCollectionValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    maifangId: false,
                    yonghuId: false,
                    maifangCollectionTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    maifangId: '',
                    yonghuId: '',
                    maifangCollectionTypes: '',
                    insertTime: '',
                },
                maifangCollectionTypesOptions : [],
                maifangOptions : [],
                yonghuOptions : [],
                rules: {
                   maifangId: [
                              { required: true, message: '卖房不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=maifang_collection_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.maifangCollectionTypesOptions = data.data.list;
                    }
                });

         this.$http({
             url: `maifang/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.maifangOptions = data.data.list;
            }
         });
         this.$http({
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='maifangId'){
                          this.ruleForm.maifangId = obj[o];
                          this.ro.maifangId = true;
                          continue;
                      }
                      if(o=='yonghuId'){
                      ...
                      if(o=='maifangCollectionTypes'){
                          this.ruleForm.maifangCollectionTypes = obj[o];
                          this.ro.maifangCollectionTypes = true;
                          continue;
                      }
                      if(o=='insertTime'){
            ...
            info(id) {
                this.$http({
                    url: `maifangCollection/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.ruleForm = data.data;
                        this.maifangChange(data.data.maifangId)
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`maifangCollection/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.maifangCollectionCrossAddOrUpdateFlag = false;
                                        this.parent.search();
