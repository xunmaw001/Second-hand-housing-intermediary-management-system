...
<template>
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='xiaoqu'">
                    <el-form-item class="select" v-if="type!='info'"  label="小区" prop="xiaoquId">
                        <el-select v-model="ruleForm.xiaoquId" filterable placeholder="请选择小区" @change="xiaoquChange">
                            <el-option
                                    v-for="(item,index) in xiaoquOptions"
                                    v-bind:key="item.id"
                                    :label="item.xiaoquName"
                                    :value="item.id">
                            </el-option>
                        </el-select>
                    </el-form-item>
                ...
                <el-col :span="12"  v-if="sessionTable !='xiaoqu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="小区名" prop="xiaoquName">
                        <el-input v-model="xiaoquForm.xiaoquName"
                                  placeholder="小区名" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='xiaoqu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="建筑年代" prop="xiaoquNiandai">
                        <el-input v-model="xiaoquForm.xiaoquNiandai"
                                  placeholder="建筑年代" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='xiaoqu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="建筑类型" prop="xiaoquValue">
                        <el-input v-model="xiaoquForm.xiaoquValue"
                                  placeholder="建筑类型" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='xiaoqu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="物业公司" prop="wuyeValue">
                        <el-input v-model="xiaoquForm.wuyeValue"
                                  placeholder="物业公司" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12"  v-if="sessionTable !='xiaoqu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="每平米价格" prop="wuyeMoney">
                        <el-input v-model="xiaoquForm.wuyeMoney"
                                  placeholder="每平米价格" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
            ...
            <input id="xiaoquId" name="xiaoquId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="房间" prop="chuzuName">
                       <el-input v-model="ruleForm.chuzuName"
                                 placeholder="房间" clearable  :readonly="ro.chuzuName"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.chuzuPhoto" label="房屋图片" prop="chuzuPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.chuzuPhoto?ruleForm.chuzuPhoto:''"
                            @change="chuzuPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="出租方式" prop="chuzuTypes">
                        <el-select v-model="ruleForm.chuzuTypes" placeholder="请选择出租方式">
                            <el-option
                                v-for="(item,index) in chuzuTypesOptions"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="房租价格/月" prop="chuzuMoney">
                       <el-input v-model="ruleForm.chuzuMoney"
                                 placeholder="房租价格/月" clearable  :readonly="ro.chuzuMoney"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="水费/吨" prop="shuiMoney">
                       <el-input v-model="ruleForm.shuiMoney"
                                 placeholder="水费/吨" clearable  :readonly="ro.shuiMoney"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电费/度" prop="dianMoney">
                       <el-input v-model="ruleForm.dianMoney"
                                 placeholder="电费/度" clearable  :readonly="ro.dianMoney"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="保洁/月" prop="baojieMoney">
                       <el-input v-model="ruleForm.baojieMoney"
                                 placeholder="保洁/月" clearable  :readonly="ro.baojieMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="房屋类型" prop="fangxingTypes">
                        <el-select v-model="ruleForm.fangxingTypes" placeholder="请选择房屋类型">
                            <el-option
                                v-for="(item,index) in fangxingTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="房屋平方" prop="pingfang">
                       <el-input v-model="ruleForm.pingfang"
                                 placeholder="房屋平方" clearable  :readonly="ro.pingfang"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="装修方式" prop="zhuangxiuTypes">
                        <el-select v-model="ruleForm.zhuangxiuTypes" placeholder="请选择装修方式">
                            <el-option
                                v-for="(item,index) in zhuangxiuTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="房屋朝向" prop="chaoxiangTypes">
                        <el-select v-model="ruleForm.chaoxiangTypes" placeholder="请选择房屋朝向">
                            <el-option
                                v-for="(item,index) in chaoxiangTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="所属区域" prop="quyuTypes">
                        <el-select v-model="ruleForm.quyuTypes" placeholder="请选择所属区域">
                            <el-option
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="房屋特色" prop="tese">
                       <el-input v-model="ruleForm.tese"
                                 placeholder="房屋特色" clearable  :readonly="ro.tese"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="详细地址" prop="xiangxi">
                       <el-input v-model="ruleForm.xiangxi"
                                 placeholder="详细地址" clearable  :readonly="ro.xiangxi"></el-input>
                   </el-form-item>
                   <div v-else>
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="房屋详细介绍" prop="chuzuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.chuzuContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.chuzuContent" label="房屋详细介绍" prop="chuzuContent">
                            <span v-html="ruleForm.chuzuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="是否出租" prop="yizuTypes">
                        <el-select v-model="ruleForm.yizuTypes" placeholder="请选择是否出租">
                            <el-option
                                v-for="(item,index) in yizuTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    fangxingTypes: false,
                    pingfang: false,
                    zhuangxiuTypes: false,
                    chaoxiangTypes: false,
                    louceng: false,
                    quyuTypes: false,
                    tese: false,
                    xiangxi: false,
                ...
                chuzuTypesOptions : [],
                fangxingTypesOptions : [],
                zhuangxiuTypesOptions : [],
                chaoxiangTypesOptions : [],
                quyuTypesOptions : [],
                yizuTypesOptions : [],
                xiaoquOptions : [],
                yonghuOptions : [],
                rules: {
                   ...
                   chuzuTypes: [
                              { required: true, message: '出租方式不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   chuzuMoney: [
                              { required: true, message: '房租价格/月不能为空', trigger: 'blur' },
                   ...
                   shuiMoney: [
                              { required: true, message: '水费/吨不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
                   ...
                   dianMoney: [
                              { required: true, message: '电费/度不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
                   ...
                   baojieMoney: [
                              { required: true, message: '保洁/月不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
                   ...
                   pingfang: [
                              { required: true, message: '房屋平方不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]{0,6}(\.[0-9]{1,2})?$/,
                                  message: '只允许输入整数6位,小数2位的数字',
                                  trigger: 'blur'
                              }
                   ...
                   zhuangxiuTypes: [
                              { required: true, message: '装修方式不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   tese: [
                              { required: true, message: '房屋特色不能为空', trigger: 'blur' },
                          ],
                   xiangxi: [
                              { required: true, message: '详细地址不能为空', trigger: 'blur' },
                          ],
                   chuzuContent: [
                              { required: true, message: '房屋详细介绍不能为空', trigger: 'blur' },
                          ],
                   yizuTypes: [
        ...
        created() {
            ...
            /*if (this.role != "管理员"){
                this.ro.chuzuMoney = true;
                this.ro.shuiMoney = true;
                this.ro.dianMoney = true;
                this.ro.baojieMoney = true;
            }*/
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=chuzu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.chuzuTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=fangxing_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.fangxingTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=zhuangxiu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.zhuangxiuTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=chaoxiang_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.chaoxiangTypesOptions = data.data.list;
                    }
                });
                this.$http({
                ...
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yizu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yizuTypesOptions = data.data.list;
                    }
                });

         this.$http({
             url: `xiaoqu/page?page=1&limit=100`,
             method: "get"
         }).then(({ data }) => {
             if (data && data.code === 0) {
                this.xiaoquOptions = data.data.list;
            }
         });
         this.$http({
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='xiaoquId'){
                          this.ruleForm.xiaoquId = obj[o];
                          this.ro.xiaoquId = true;
                          continue;
                      }
                      if(o=='chuzuName'){
                          this.ruleForm.chuzuName = obj[o];
                          this.ro.chuzuName = true;
                          continue;
                      }
                      if(o=='chuzuPhoto'){
                          this.ruleForm.chuzuPhoto = obj[o];
                          this.ro.chuzuPhoto = true;
                          continue;
                      }
                      if(o=='chuzuTypes'){
                          this.ruleForm.chuzuTypes = obj[o];
                          this.ro.chuzuTypes = true;
                          continue;
                      }
                      if(o=='chuzuMoney'){
                          this.ruleForm.chuzuMoney = obj[o];
                          this.ro.chuzuMoney = true;
                          continue;
                      }
                      if(o=='shuiMoney'){
                          this.ruleForm.shuiMoney = obj[o];
                          this.ro.shuiMoney = true;
                          continue;
                      }
                      if(o=='dianMoney'){
                          this.ruleForm.dianMoney = obj[o];
                          this.ro.dianMoney = true;
                          continue;
                      }
                      if(o=='baojieMoney'){
                          this.ruleForm.baojieMoney = obj[o];
                          this.ro.baojieMoney = true;
                          continue;
                      }
                      if(o=='fangxingTypes'){
                          this.ruleForm.fangxingTypes = obj[o];
                          this.ro.fangxingTypes = true;
                          continue;
                      }
                      if(o=='pingfang'){
                          this.ruleForm.pingfang = obj[o];
                          this.ro.pingfang = true;
                          continue;
                      }
                      if(o=='zhuangxiuTypes'){
                          this.ruleForm.zhuangxiuTypes = obj[o];
                          this.ro.zhuangxiuTypes = true;
                          continue;
                      }
                      if(o=='chaoxiangTypes'){
                          this.ruleForm.chaoxiangTypes = obj[o];
                          this.ro.chaoxiangTypes = true;
                          continue;
                      }
                      if(o=='louceng'){
                      ...
                      if(o=='quyuTypes'){
                          this.ruleForm.quyuTypes = obj[o];
                          this.ro.quyuTypes = true;
                          continue;
                      }
                      if(o=='tese'){
                      ...
                      if(o=='chuzuContent'){
                          this.ruleForm.chuzuContent = obj[o];
                          this.ro.chuzuContent = true;
                          continue;
                      }
                      if(o=='yizuTypes'){
                          this.ruleForm.yizuTypes = obj[o];
                          this.ro.yizuTypes = true;
                          continue;
                      }
                      if(o=='insertTime'){
            ...
            info(id) {
                this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        this.xiaoquChange(data.data.xiaoquId)
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`chuzu/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.chuzuCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            chuzuPhotoUploadChange(fileUrls){
                this.ruleForm.chuzuPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
