 ...
 */
@TableName("maifang")
public class MaifangView extends MaifangEntity implements Serializable {
	...
	public MaifangView(MaifangEntity maifangEntity) {
		try {
			BeanUtils.copyProperties(this, maifangEntity);
