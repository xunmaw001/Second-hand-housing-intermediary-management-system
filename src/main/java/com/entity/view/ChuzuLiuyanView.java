...
public class ChuzuLiuyanView extends ChuzuLiuyanEntity implements Serializable {
	...
	public Integer getChuzuYonghuId() {
		return chuzuYonghuId;
	}

	public void setChuzuYonghuId(Integer chuzuYonghuId) {
		this.chuzuYonghuId = chuzuYonghuId;
	}
//级联表的get和set chuzu
					/**
					* 获取： 房间
