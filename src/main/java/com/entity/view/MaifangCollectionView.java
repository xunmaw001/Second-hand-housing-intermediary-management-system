 ...
 */
@TableName("maifang_collection")
public class MaifangCollectionView extends MaifangCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 类型的值
		*/
		private String maifangCollectionValue;
	...
	public MaifangCollectionView() {

	}

	public MaifangCollectionView(MaifangCollectionEntity maifangCollectionEntity) {
		try {
			BeanUtils.copyProperties(this, maifangCollectionEntity);
			...
			* 获取： 类型的值
			*/
			public String getMaifangCollectionValue() {
				return maifangCollectionValue;
			}
			/**
			* 设置： 类型的值
			*/
			public void setMaifangCollectionValue(String maifangCollectionValue) {
				this.maifangCollectionValue = maifangCollectionValue;
			}
